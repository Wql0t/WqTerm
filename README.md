## WqTerm — библиотека для создания игр в терминале (C++)

WqTerm — это лёгкая заголовочная библиотека для создания простых ASCII/Unicode-игр в терминале Linux. В комплекте есть утилита редактора карт (`MapMaker`).
...
---
## Простой пример с перемещением игрока
```cpp
#include "wqterm.hpp"
Game g(20, 30);
Entity player(3, 15, "☻");
